...
export type GetTrainingStatsQuery = { __typename?: 'Query', trainingStats: { __typename?: 'TrainingStats', total: number, pending: number, annotated: number, avgRqi: number, goodCount: number, fairCount: number, poorCount: number } };
...
export type RunAnalysisMutation = { __typename?: 'Mutation', runAnalysis: { __typename?: 'Job', jobId: string } };

export type StartModelTrainingMutationVariables = Exact<{ [key: string]: never; }>;


export type StartModelTrainingMutation = { __typename?: 'Mutation', startModelTraining: { __typename?: 'Job', jobId: string } };
...
export type GetJobStatusQuery = { __typename?: 'Query', job?: { __typename?: 'Job', jobId: string, status: string, progress: number, total: number, message: string, error?: string | null } | null };
