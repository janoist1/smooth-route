...
class ColabTrainingProvider(BaseTrainingProvider):
    ...
    def __init__(self, export_dir: str = None):
        self.export_dir = export_dir or os.path.join(
            settings.resolve_data_dir(), "exports"
        )
    ...
    def _generate_notebook(self, config: TrainingConfig, timestamp: str) -> str:
        """Generate a Colab notebook for YOLO training."""
        ...
        cells = [
            ...
            },
            {
                ...
                "source": [
                    ...
                    "print('A best.pt fájlt töltsd fel a Smooth Route /data/models/ mappába!')"
                ]
            }
        ]
    ...
    def _export_dataset(self, config: TrainingConfig, timestamp: str) -> str:
        ...
        dataset_dir = os.path.join(config.data_dir, "training_dataset")
...
7. **Másold a modellt** a `data/models/` mappába
"""

def get_colab_export_path() -> str:
    """Get the export directory path."""
    return os.path.join(settings.resolve_data_dir(), "exports")
